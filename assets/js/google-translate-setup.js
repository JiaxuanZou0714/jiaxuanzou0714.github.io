...
window.googleTranslateConfig = {
  pageLanguage: "{{ site.google_translate.page_language | default: site.lang | default: 'en' }}",
  includedLanguages: "{{ site.google_translate.included_languages | default: 'en,zh-CN' }}"
};
  ...
  new google.translate.TranslateElement(
    {
      ...
      layout: google.translate.TranslateElement.InlineLayout.{{ site.google_translate.layout | default: 'SIMPLE' }},
      autoDisplay: false
    },
