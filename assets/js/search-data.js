...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        description: "当梯度信号被噪声淹没时，行归一化优化器为何能有效工作？本文通过数学推导揭示：它的核心优势并非方向修正，而是零次齐次映射带来的更新幅值饱和与隐式逆噪声加权——在多块异方差场景下体现为真正有用的块自适应学习率。",aliases: "deep-learning, optimization, deep-learning, llm, scaling-law",section: "Posts",
        handler: () => {
      ...
      },{id: "news-excited-to-announce-that-i-have-officially-joined-the-scalingopt-project-i-will-be-co-maintaining-this-amazing-systematic-platform-and-working-on-the-frontiers-of-optimizer-design-for-large-language-models",
          title: 'Excited to announce that I have officially joined the ScalingOpt project! I will...',
          description: "",
