...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        description: "两个问题。调度对象：weight norm 的变化在 base lr schedule 之上叠加一层隐式调度，Hyperball 移除的是这一层，起作用的量为 effective lr。形状：峰值加衰减为 bias–variance trade-off 的解，早期偏差项占主导、末期方差项占主导，满足该平衡的形状构成一个集合，不限于特定的解析形式。",aliases: "deep-learning, deep-learning, lr-schedule, optimizer, spherical-dynamics, scaling-law",section: "Posts",
        handler: () => {
        ...
        description: "回顾本科前两年的经历，从最初预设的直博路径，到创办研讨班、持续公开技术输出、进入高瓴与字节 Seed 实验室。结合这些过程，总结关于动态调整规划、公开输出的长期积累以及高密度环境对认知迭代的影响。",aliases: "Growth Reflections, Cognitive Compounding, Undergraduate Growth, Career Planning, AI Industry",section: "Posts",
        handler: () => {
        ...
        handler: () => {
          ...
          section: "En_posts",handler: () => {
            ...
            },},{id: "en_posts-two-years-of-undergraduate-studies-cognitive-compounding",
