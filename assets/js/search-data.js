...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        description: "很多人习惯用当下的低阶认知做长远线性规划，陷入短期付出看不到回报的焦虑。本文结合我两年本科的真实成长经历，拆解「认知复利」的底层逻辑与实践路径，说明持续输出、重仓高密度环境、高频迭代认知才能实现成长的滚雪球效应。",aliases: "Growth Reflections, Cognitive Compounding, Undergraduate Growth, Career Planning, AI Industry",section: "Posts",
        handler: () => {
